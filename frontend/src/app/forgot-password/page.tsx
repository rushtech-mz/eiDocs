          ...
          {sent ? (
            <div className="space-y-4">
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 text-sm font-medium"
              >
