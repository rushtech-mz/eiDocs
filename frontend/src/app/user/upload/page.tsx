...
const UploadPage = () => {
  ...
  useEffect(() => {
    if (user?.nome && formData.tipoMovimento === 'interno' && formData.responsavel !== user.nome) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    readOnly
                    disabled
                    className="block w-full pl-10 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                  />
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Preenchido automaticamente com o utilizador autenticado.</p>
              </div>
            )}
